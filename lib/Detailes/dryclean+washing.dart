...
class Details_dry_clean_washing extends StatefulWidget {
  String name_service;

  Details_dry_clean_washing(this.name_service);

  @override
  State<Details_dry_clean_washing> createState() => _Details_dry_washing_cleanState(this.name_service);
}

class _Details_dry_washing_cleanState extends State<Details_dry_clean_washing> {
  String name_service;
